...
function createHighScore(highScore) {
  ...
  initialsContainerEl.appendChild(createText('Initials: ', highScore.initials.toUpperCase()));
  finalScoreContainerEl.appendChild(createText('Score: ', highScore.finalScore + "%"));
  timeLeftContainerEl.appendChild(createText('Time Left: ', highScore.timeLeft +"s"));


  var containers = [initialsContainerEl, finalScoreContainerEl, timeLeftContainerEl];
